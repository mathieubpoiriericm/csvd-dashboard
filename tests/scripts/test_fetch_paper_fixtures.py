...
class TestManifest:
    def test_the_manifest_sits_beside_the_fixtures(self) -> None:
        # The committed manifest's contents are pinned in
        # tests/scripts/csvd/test_csvd_fetch_paper_fixtures.py; a fork has no
        # fixtures and no manifest, so only the arrangement is checked here.
